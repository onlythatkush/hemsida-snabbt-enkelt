    ...
    <html lang="sv" className="dark">
      ...
      <body>
        ...
        <div aria-hidden className="pointer-events-none fixed inset-0 -z-35">
          ...
          <span className="absolute top-[35%] left-[68%] h-1 w-1 rounded-full bg-amber-300 shadow-[0_0_8px_2px_rgba(252,211,77,0.7)] animate-twinkle" style={{ animationDelay: "1.6s" }} />
          <span className="absolute top-[44%] left-[12%] h-[2px] w-[2px] rounded-full bg-orange-200 shadow-[0_0_6px_2px_rgba(254,215,170,0.7)] animate-twinkle" style={{ animationDelay: "2.2s" }} />
          <span className="absolute top-[50%] left-[55%] h-1 w-1 rounded-full bg-yellow-200 shadow-[0_0_10px_3px_rgba(254,240,138,0.7)] animate-twinkle" style={{ animationDelay: "1.1s" }} />
          <span className="absolute top-[58%] left-[80%] h-[3px] w-[3px] rounded-full bg-amber-100 shadow-[0_0_10px_3px_rgba(254,243,199,0.7)] animate-twinkle" style={{ animationDelay: "0.4s" }} />
          <span className="absolute top-[40%] left-[90%] h-1 w-1 rounded-full bg-yellow-300 shadow-[0_0_8px_2px_rgba(253,224,71,0.7)] animate-twinkle" style={{ animationDelay: "2.8s" }} />
